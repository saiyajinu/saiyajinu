...
const StatsPost = (props: StatsPostProps) => {
  return (
    <div className="bg-posts w-fit text-base sm:text-lg rounded-xl shadow-md py-12 px-8 relative overflow-hidden duration-300 transition-transform hover:-translate-y-2 smlr:even:top-10">
